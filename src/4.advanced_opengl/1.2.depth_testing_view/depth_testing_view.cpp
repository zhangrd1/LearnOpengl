...
int main()
{
    ...
    // 创建 Object VAO
    ResourceID objectVAO, VBO, objectEBOA, objectEBOB;
    ...
    glGenBuffers(1, &objectEBOA);
    glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, objectEBOA);
    ...
    // 创建 Object VAOB
    ResourceID objectVAOB;
    glGenVertexArrays(1, &objectVAOB);
    glBindVertexArray(objectVAOB);

    glGenBuffers(1, &VBO);
    glBindBuffer(GL_ARRAY_BUFFER, VBO);
    glBufferData(GL_ARRAY_BUFFER, sizeof(vertices), vertices, GL_STATIC_DRAW);

    glGenBuffers(1, &objectEBOB);
    glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, objectEBOB);
    ...
    MyShader lightingShader(
        "D:/Opengl/src/4.advanced_opengl/1.2.depth_testing_view/1.2.depth_testing.vs",
        "D:/Opengl/src/4.advanced_opengl/1.2.depth_testing_view/1.2.depth_testing.fs",
        "lightingShader"
    );
